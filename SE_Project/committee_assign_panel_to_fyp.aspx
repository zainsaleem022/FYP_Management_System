...
<body>
    <form id="form1" runat="server">
        ...
        <div class="wlp-whitespace-only-element-expansion">&nbsp;</div>
            <div class="wlp-whitespace-only-element-expansion">
            <asp:Label runat="server" Text="Enter the FYP ID you want to Assign Panel to:" ID="ask_committee_to_enter_fyp_id_label"></asp:Label>&nbsp;</div>
        <div class="wlp-whitespace-only-element-expansion">&nbsp;</div>
        ...
        <div class="wlp-whitespace-only-element-expansion">&nbsp;</div>
            <div class="wlp-whitespace-only-element-expansion">
            <asp:Label runat="server" Text="Enter the Panel ID you want to Assign FYP to:" ID="ask_committee_to_enter_panel_id_label"></asp:Label>&nbsp;</div>
            <div class="wlp-whitespace-only-element-expansion">&nbsp;</div>
            <div class="form-group">
