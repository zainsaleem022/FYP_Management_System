...
<body>
    <form id="form2" runat="server">
        <div>
            <asp:Label runat="server" Text="FYPs Under Supervision" ID="panel_member_view_currently_assigned_fyps_form_title_label"></asp:Label>
        </div>
        <div class="wlp-whitespace-only-element-expansion">&nbsp;</div>
        <div class="wlp-whitespace-only-element-expansion">&nbsp;</div>
        <div class="wlp-whitespace-only-element-expansion">
            <asp:Label runat="server" Text="" ID="no_currently_assigned_fyp_found_label"></asp:Label>&nbsp;</div>
        <div class="wlp-whitespace-only-element-expansion">&nbsp;</div>
        <div class="wlp-whitespace-only-element-expansion">&nbsp;</div>
